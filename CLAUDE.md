# CLAUDE.md — Bootstrap IA: Advanced AI-Powered Project Generation

> This file is the entrypoint for Claude Code. It aggregates all rules from Bootstrap IA.
> Rules are organized into **Core** (AI workflow), **Global** (always apply), and **Specific** (technology-dependent).
